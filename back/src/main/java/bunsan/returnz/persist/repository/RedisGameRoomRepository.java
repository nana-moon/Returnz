...
@Repository
public class RedisGameRoomRepository {
	...
	private void init() {
		...
		roomTopics.put("game-room", new ChannelTopic("game-room"));
		redisMessageListener.addMessageListener(redisSubscriber, roomTopics.get("game-room"));
	}
